...
export const t = {
  ...
  selectCall: "Çağrıyı seç",
  clearSelection: "Seçimi temizle",
  selectedCount: (n: number) => `${n.toLocaleString("tr-TR")} çağrı seçildi`,
  downloadSelectedZip: (n: number) => `PDF olarak indir (${n.toLocaleString("tr-TR")})`,
  zipDownloaded: (n: number) => `${n.toLocaleString("tr-TR")} çağrının PDF'i ZIP olarak indirildi`,
  noDownloadableSelected: "Seçilenler arasında henüz tamamlanmış çağrı yok",
  downloadSelectedExcel: (n: number) => `Excel olarak indir (${n.toLocaleString("tr-TR")})`,
  excelDownloaded: (n: number) => `${n.toLocaleString("tr-TR")} çağrı Excel olarak indirildi`,
  deleteSelected: (n: number) => `Seçilenleri sil (${n.toLocaleString("tr-TR")})`,
  confirmDeleteSelected: "Seçilen çağrılar silinsin mi?",
  confirmDeleteSelectedMsg: (n: number) => `${n.toLocaleString("tr-TR")} çağrı ve ilişkili ses dosyaları kalıcı olarak silinecek. Bu işlem geri alınamaz.`,
  bulkDeleted: (n: number) => `${n.toLocaleString("tr-TR")} çağrı silindi`,
